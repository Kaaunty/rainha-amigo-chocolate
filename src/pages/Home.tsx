      ...
      <div className="home-content">
        <div className="home-header">
          <h1 className="home-title">
            ...
            Amigo Chocolate
            <span className="title-subtitle">Rainha das Sete</span>
          </h1>
          <p className="home-description">
            Participe do sorteio e descubra quem será seu amigo chocolate! Cada
            participante receberá um link único para acessar seu resultado.
          </p>
        </div>
        ...
        <div className="home-info">
          <div className="info-card">
            ...
            <div>
              <h3>Como funciona?</h3>
              <p>
                Cadastre-se com seu nome e e-mail corporativo. Você receberá um
